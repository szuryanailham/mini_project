...
@section('container-fluid')
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 space-y-6">
            {{-- aploud image --}}
            <form action="/aploud-profile" method="post">
                ...
                <div class="mx-auto w-full flex items-center">
                    <button type="submit" class="mx-auto mt-5 text-sm italic text-black bg-slate-200 py-2 px-2 rounded-lg">Uploud Photo</button>
                </div>
